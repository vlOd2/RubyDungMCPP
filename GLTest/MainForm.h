...
#pragma region Windows Form Designer generated code
	void InitializeComponent(void)
	{
		...
		this->glCanvasPlaceholder->Size = System::Drawing::Size(624, 417);
		this->glCanvasPlaceholder->TabIndex = 1;
		// 
		// msMenu
		// 
		this->msMenu->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {
			this->controlsToolStripMenuItem,
				this->aboutToolStripMenuItem
		});
		this->msMenu->Location = System::Drawing::Point(0, 0);
		this->msMenu->Name = L"msMenu";
		this->msMenu->Size = System::Drawing::Size(624, 24);
		...
		this->controlsToolStripMenuItem->Size = System::Drawing::Size(64, 20);
		this->controlsToolStripMenuItem->Text = L"Controls";
		this->controlsToolStripMenuItem->Click += gcnew System::EventHandler(this, &MainForm::controlsToolStripMenuItem_Click);
		// 
		...
		this->ShowIcon = false;
		this->Text = L"RubyDung C++/CLI Edition";
...
private: System::Void controlsToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e);
};